 ...
 */
public class EsporteLazer extends Embarcacao {
    
    /*************************************************************************
     * Attributes
     ************************************************************************/
    private boolean possuiVela;
    
    /*************************************************************************
     * Constructor
     ************************************************************************/
    public EsporteLazer(int quantidadePassageiros, double comprimento,
            double largura, int velocidadeMaxima, boolean possuiVela) {
        this.quantidadePassageiros = quantidadePassageiros;
        this.comprimento = comprimento;
        this.largura = largura;
        this.velocidadeMaxima = velocidadeMaxima;
        this.possuiVela = possuiVela;
    }
}
